...
/// Добравшись до места, выбирает другую случайную точку
...
public class Enemy_4 : Enemy
{
    ...
    // Эти функции выполняют поиск части в массиве parts n
    ...
    bool Destroyed(Part prt)
    {
        ...
        {
            return true; // Да, была уничтожена
        }
        ...
        switch (other.tag)
        {
            case "ProjectileHero":
                ...
                if (prtHit.protectedBy != null)
                {
                    ...
                    {
                        // Если хотя бы одна из защищающих частей ещё
                        //не разрушена...
                        if (!Destroyed(s))
                        {
